...
def modelnet40_normal_resampled_params():
  ...
  params.datasets2use['train'] = [params.ds_path_dirs + '/*train*/']
  params.datasets2use['test'] = [params.ds_path_dirs + '/*test*/']

  #for generating walks while running
  #params.ds_path ='datasets_processed/modelnet40_normal_resampled'
  ...
  # Parameters to recheck:
  params.iters_to_train = 140e3
  params.net_input = ['xyz', 'vertex_normals']
  params.walk_alg = 'local_jumps'


  #for dirs version
  params.net_input_dim = 6
...
def future3d_params():
  ...
  # Set to start from prev net
  #path = 'runs/0300-08.03.2022..15.11__future3d/learned_model2keep__00015048.keras'
  #params.net_start_from_prev_net = path
